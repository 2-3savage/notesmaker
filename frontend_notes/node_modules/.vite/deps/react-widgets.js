...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useFocusManager.js
var import_react7 = __toESM(require_react());

// node_modules/react-widgets/node_modules/@restart/hooks/esm/useEventCallback.js
var import_react5 = __toESM(require_react());

// node_modules/react-widgets/node_modules/@restart/hooks/esm/useCommittedRef.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useMounted.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useEventListener.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useGlobalListener.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useCustomEffect.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useUpdateImmediateEffect.js
var import_react31 = __toESM(require_react());

// node_modules/react-widgets/node_modules/@restart/hooks/esm/useStableMemo.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useUpdatedRef.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useWillUnmount.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useImmediateUpdateEffect.js
var useImmediateUpdateEffect_default = useUpdateImmediateEffect_default;

// node_modules/react-widgets/node_modules/@restart/hooks/esm/useMutationObserver.js
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useCallbackRef.js
var import_react33 = __toESM(require_react());
function useCallbackRef() {
  return (0, import_react33.useState)(null);
}

// node_modules/react-widgets/node_modules/@restart/hooks/esm/useMergedRefs.js
...
var SlideDownTransition = class extends import_react36.default.Component {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return import_react36.default.createElement(Transition_default, _extends14({}, props, {
      appear: true,
      in: this.props.in,
      ...
      timeout: void 0
      /*hack*/
    }), (status, innerProps) => import_react36.default.createElement("div", _extends14({}, innerProps, {
      className: (0, import_classnames12.default)(className, dropUp && "rw-dropup", transitionClasses[status])
    }), import_react36.default.cloneElement(children, {
...
var StaticContainer = import_react37.default.memo(({
  children
}) => children, (_, {
  shouldUpdate
}) => !shouldUpdate);
var Popup = import_react37.default.forwardRef((_ref, ref) => {
  let {
    id,
    role,
    dropUp,
  ...
  return import_react37.default.createElement(Transition, _extends15({}, props, {
    in: open,
    dropUp,
    timeout: void 0,
    ...
    ref,
    role
  }, import_react37.default.createElement(StaticContainer, {
    shouldUpdate: open
  }, children)));
});
...
function InputAddon(_ref) {
  ...
  return import_react38.default.createElement(Button_default, _extends16({}, props, {
...
var ComboboxImpl = React25.forwardRef(function Combobox(_ref, outerRef) {
  let {
    id,
    className,
    containerClassName,
  ...
  const listRef = (0, import_react43.useRef)(null);
  const [suggestion, setSuggestion] = (0, import_react43.useState)(null);
  const shouldFilter = (0, import_react43.useRef)(false);
  ...
  const selectedItem = (0, import_react43.useMemo)(() => data[accessors.indexOf(data, currentValue)], [data, currentValue, accessors]);
  ...
  (0, import_react43.useImperativeHandle)(outerRef, () => ({
    focus
  }));
  ...
  if (!hideCaret) {
    inputAddon = React25.createElement(InputAddon_default, {
      busy,
      icon: selectIcon,
      spinner: busySpinner,
      onClick: handleClick,
    ...
    inputAddon = React25.createElement("span", {
      "aria-hidden": "true",
      className: "rw-btn rw-picker-caret"
    }, busySpinner || Spinner);
  }
  return React25.createElement(Widget_default, _extends18({}, elementProps, {
    ref,
    open: currentOpen,
    dropUp,
    focused,
    ...
    ref: inputRef
  })), inputAddon), React25.createElement(FocusListContext.Provider, {
    value: list.context
  }, shouldRenderPopup && React25.createElement(Popup2, _extends18({}, popupProps, {
    dropUp,
    open: popupOpen,
    transition: popupTransition,
    onEntering: () => listRef.current.scrollIntoView()
  }), React25.createElement(ListComponent, _extends18({}, listProps, {
    id: listId,
    tabIndex: -1,
    data,
    groupBy,
...
var DatePickerInput = import_react44.default.forwardRef((_ref, ref) => {
  let {
    value,
    formatter,
    editing,
  ...
  const needsFlush = (0, import_react44.useRef)(false);
  const nextTextValue = (0, import_react44.useMemo)(() => value instanceof Date && isValid(value) ? localizer.formatDate(value, formatter, editing ? editFormat : displayFormat) : "", [value, formatter, localizer, displayFormat, editing, editFormat]);
  const [prevValue, setPrevValue] = (0, import_react44.useState)(nextTextValue);
  const [textValue, setTextValue] = (0, import_react44.useState)(nextTextValue);
  ...
  return import_react44.default.createElement(Input_default, _extends19({}, props, {
    type: "text",
    ref,
...
var DateTimePartInput = import_react45.default.forwardRef((_ref, ref) => {
  let {
    value,
  ...
  return import_react45.default.createElement("input", _extends20({}, props, {
    ref,
    "data-focusable": true,
    autoComplete: "off",
    role: "spinbutton",
...
var propTypes6 = {
   ...
   * @default new Date()
   **/
  datePart: import_prop_types8.default.instanceOf(Date),
  /**
   * Use a 12 hour clock (with AM/PM) instead of 24 hour one.
   * The configured localizer may provide a default value .
   **/
  use12HourClock: import_prop_types8.default.bool,
  /** Time part values will be padded by `0` */
  padValues: import_prop_types8.default.bool,
  /** The string character used to pad empty, or cleared values */
  emptyCharacter: import_prop_types8.default.string,
  /** Hide the input clear button */
  noClearButton: import_prop_types8.default.bool,
  /**
   * @example ['disabled', ['new Date()']]
   */
  ...
  precision: import_prop_types8.default.oneOf(["minutes", "seconds", "milliseconds"]).isRequired,
  /**
   * The seperator between hours and minutes
   * @default ':'
   */
  hoursAddon: import_prop_types8.default.node,
  /**
   * The seperator between hours and minutes
   * @default ':'
   */
  minutesAddon: import_prop_types8.default.node,
  /**
   * The seperator between hours and minutes
   * @default ':'
   */
  secondsAddon: import_prop_types8.default.node,
  /**
   * The seperator between hours and minutes
   * @default '.'
   */
  millisecondsAddon: import_prop_types8.default.node
};
var defaultProps = {
  hoursAddon: ":",
  padValues: true,
...
function useTimePartState(value, use12HourClock) {
  ...
  const setTimeParts = (0, import_react46.useCallback)((timeParts) => setState((s) => Object.assign({}, s, {
    timeParts
  })), [setState]);
...
function TimeInput(uncontrolledProps) {
  ...
  const hourRef = (0, import_react46.useRef)(null);
  const [focusEvents, focused] = useFocusManager2(ref, {
    disabled: disabled2,
    onBlur,
    onFocus
  ...
  return import_react46.default.createElement(Widget_default, _extends21({}, props, {
    role: "group",
    ref
  }, focusEvents, {
    focused,
  ...
  }), import_react46.default.createElement(DateTimePartInput_default, {
    size: 2,
    pad: pad ? 2 : void 0,
    value: hours2,
    disabled: disabled2,
  ...
  }), hoursAddon && import_react46.default.createElement("span", null, hoursAddon), import_react46.default.createElement(DateTimePartInput_default, {
    size: 2,
    pad: pad ? 2 : void 0,
    value: minutes2,
    disabled: disabled2,
  ...
  }), minsAddon && import_react46.default.createElement("span", null, minsAddon), (precision === "seconds" || precision === "milliseconds") && import_react46.default.createElement(import_react46.default.Fragment, null, import_react46.default.createElement(DateTimePartInput_default, {
    size: 2,
    pad: pad ? 2 : void 0,
    value: seconds2,
    disabled: disabled2,
  ...
  }), secsAddon && import_react46.default.createElement("span", null, secsAddon)), precision === "milliseconds" && import_react46.default.createElement(import_react46.default.Fragment, null, import_react46.default.createElement(DateTimePartInput_default, {
    size: 3,
    pad: pad ? 3 : void 0,
    value: milliseconds2,
    disabled: disabled2,
  ...
  }), millisecondsAddon && import_react46.default.createElement("span", null, millisecondsAddon)), use12HourClock && import_react46.default.createElement("div", {
    role: "listbox",
    "aria-label": "AM/PM",
    "aria-disabled": disabled2,
    "aria-readonly": readOnly,
  ...
  }, import_react46.default.createElement("abbr", null, meridiem))), !noClearButton && import_react46.default.createElement(Button_default, {
    label: "clear input",
    onClick: handleClear,
...
function useTabTrap(ref, selector = defaultSelector) {
  const startedRef = (0, import_react47.useRef)(false);
...
var propTypes7 = {
  ...
  onToggle: import_prop_types9.default.func,
  /**
   * Default current date at which the calendar opens. If none is provided, opens at today's date or the `value` date (if any).
   */
  currentDate: import_prop_types9.default.instanceOf(Date),
  /**
   * Change event Handler that is called when the currentDate is changed. The handler is called with the currentDate object.
   */
  onCurrentDateChange: import_prop_types9.default.func,
   ...
   */
  valueFormat: import_prop_types9.default.any,
  /**
   ...
   * ```
   */
  valueDisplayFormat: import_prop_types9.default.any,
  /**
   ...
   * ```
   */
  valueEditFormat: import_prop_types9.default.any,
  /**
   * Enable the time list component of the picker.
   */
  includeTime: import_prop_types9.default.bool,
  timePrecision: import_prop_types9.default.oneOf(["minutes", "seconds", "milliseconds"]),
  timeInputProps: import_prop_types9.default.object,
  /** Specify the element used to render the calendar dropdown icon. */
  selectIcon: import_prop_types9.default.node,
  dropUp: import_prop_types9.default.bool,
  popupTransition: import_prop_types9.default.elementType,
   ...
   */
  parse: import_prop_types9.default.oneOfType([import_prop_types9.default.any, import_prop_types9.default.func]),
  /** @ignore */
  tabIndex: import_prop_types9.default.any,
  /** @ignore */
  "aria-labelledby": import_prop_types9.default.string,
  /** @ignore */
  "aria-describedby": import_prop_types9.default.string,
  /** @ignore */
  localizer: import_prop_types9.default.any,
  onKeyDown: import_prop_types9.default.func,
  onKeyPress: import_prop_types9.default.func,
  onBlur: import_prop_types9.default.func,
  onFocus: import_prop_types9.default.func,
  /** Adds a css class to the input container element. */
  containerClassName: import_prop_types9.default.string,
  calendarProps: import_prop_types9.default.object,
  inputProps: import_prop_types9.default.object,
  messages: import_prop_types9.default.shape({
    dateButton: import_prop_types9.default.string
  })
};
...
var DatePicker = import_react48.default.forwardRef((uncontrolledProps, outerRef) => {
  const _useUncontrolled = useUncontrolled(uncontrolledProps, {
    open: "onToggle",
    value: "onChange",
  ...
  const calRef = (0, import_react48.useRef)(null);
  ...
  const dateParser = (0, import_react48.useCallback)((str) => {
  ...
  (0, import_react48.useImperativeHandle)(outerRef, () => ({
    focus
  }));
  ...
  return import_react48.default.createElement(Widget_default, _extends22({}, elementProps, {
    defaultValue: void 0,
    open: !!open,
    dropUp,
    focused,
  ...
  }), import_react48.default.createElement(WidgetPicker_default, {
    className: containerClassName
  }, import_react48.default.createElement(DatePickerInput_default, _extends22({}, inputProps, {
    id: inputId,
    ref,
    role: "combobox",
    name,
    ...
    "aria-expanded": !!open,
    "aria-owns": dateId
  })), import_react48.default.createElement(InputAddon_default, {
    icon: selectIcon,
    label: localizer.messages.dateButton(),
    disabled: disabled2 || readOnly,
    onClick: handleCalendarClick
  })), !!shouldRenderList && import_react48.default.createElement(Popup2, _extends22({}, popupProps, {
    dropUp,
    open,
    role: "dialog",
    ref: calRef,
  ...
  }), import_react48.default.createElement(Calendar_default, _extends22({
    min: min2,
    max: max2,
    bordered: false
  }, calendarProps, {
    ...
    "aria-live": "polite",
    "aria-labelledby": inputId
  })), includeTime && import_react48.default.createElement(TimeInput_default, _extends22({}, timeInputProps, {
    value,
...
// node_modules/react-widgets/node_modules/@restart/hooks/esm/useTimeout.js
...
function useTimeout() {
  const isMounted = useMounted();
  const handleRef = (0, import_react49.useRef)();
...
var CREATE_OPTION = {};
var propTypes8 = {
  searchTerm: PropTypes12.string,
  focused: PropTypes12.bool,
  onSelect: PropTypes12.func.isRequired,
  activeId: PropTypes12.string
};
function AddToListOption(_ref) {
  let {
    children
  } = _ref, props = _objectWithoutPropertiesLoose23(_ref, _excluded22);
  return import_react50.default.createElement(ListOption_default, _extends23({}, props, {
...
var DropdownListInput = import_react51.default.forwardRef(function({
  name,
  autoComplete,
  value,
  allowSearch,
  ...
  const [autofilling, setAutofilling] = (0, import_react51.useState)(false);
  const searchRef = (0, import_react51.useRef)(null);
  ...
  if (strValue === String({}))
    strValue = "";
  const inputValue = !value && placeholder ? import_react51.default.createElement("span", {
  ...
  return import_react51.default.createElement("div", {
  ...
  }, autoComplete !== "off" && import_react51.default.createElement("input", {
    name,
    tabIndex: -1,
    disabled: disabled2,
    readOnly,
  ...
  }), import_react51.default.createElement(import_react51.default.Fragment, null, allowSearch && import_react51.default.createElement("input", {
    ref: searchRef,
    disabled: disabled2,
    readOnly,
    style: style2,
    ...
    onChange: onSearch
  }), !searchTerm && import_react51.default.createElement("span", {
...
var DropdownCaret = (_ref) => {
  ...
  return React32.createElement("span", _extends24({}, props, {
    "aria-hidden": "true",
...
var propTypes9 = {
  ...
  onToggle: import_prop_types10.default.func,
  data: import_prop_types10.default.array,
  dataKey: accessor,
  textField: accessor,
  allowCreate: import_prop_types10.default.oneOf([true, false, "onFilter"]),
  /**
   * A React render prop for customizing the rendering of the DropdownList
   * value
   */
  renderValue: import_prop_types10.default.func,
  renderListItem: import_prop_types10.default.func,
  listComponent: elementType2,
  optionComponent: elementType2,
  renderPopup: import_prop_types10.default.func,
  renderListGroup: import_prop_types10.default.func,
  groupBy: accessor,
  /**
   *
   * @type {(dataItem: ?any, metadata: { originalEvent: SyntheticEvent }) => void}
  ...
  onCreate: import_prop_types10.default.func,
  /**
   * @type function(searchTerm: string, metadata: { action, lastSearchTerm, originalEvent? })
   */
  onSearch: import_prop_types10.default.func,
  searchTerm: import_prop_types10.default.string,
  busy: import_prop_types10.default.bool,
  /** Specify the element used to render the select (down arrow) icon. */
  selectIcon: import_prop_types10.default.node,
  /** Specify the element used to render the busy indicator */
  busySpinner: import_prop_types10.default.node,
  placeholder: import_prop_types10.default.string,
  dropUp: import_prop_types10.default.bool,
  ...
  listProps: import_prop_types10.default.object,
  messages: import_prop_types10.default.shape({
    open: import_prop_types10.default.string,
    emptyList: message,
    emptyFilter: message,
...
function useSearchWordBuilder(delay) {
  ...
  const wordRef = (0, import_react52.useRef)("");
...
var DropdownListImpl = import_react52.default.forwardRef(function DropdownList(_ref, outerRef) {
  let {
    id,
    autoFocus,
    textField,
  ...
  const filterRef = (0, import_react52.useRef)(null);
  ...
  const selectedItem = (0, import_react52.useMemo)(() => data[accessors.indexOf(data, currentValue)], [data, currentValue, accessors]);
  const list = useFocusList({
    activeId,
    scope: ref,
    focusFirstItem,
  ...
  const [autofilling, setAutofilling] = (0, import_react52.useState)(false);
  ...
  (0, import_react52.useImperativeHandle)(outerRef, () => ({
    focus
  }));
  let valueItem = accessors.findOrSelf(data, currentValue);
  let shouldRenderPopup = useFirstFocusedRender(focused, currentOpen);
  ...
  return import_react52.default.createElement(FocusListContext.Provider, {
    value: list.context
  }, import_react52.default.createElement(Widget_default, _extends25({}, widgetProps, {
    open: !!currentOpen,
    dropUp: !!dropUp,
    focused: !!focused,
    disabled: isDisabled,
    ...
    ref
  }), import_react52.default.createElement(WidgetPicker_default, {
    onClick: handleClick,
    tabIndex: filter ? -1 : 0,
    className: (0, import_classnames21.default)(containerClassName, "rw-widget-input")
  }, import_react52.default.createElement(DropdownListInput_default, _extends25({}, inputProps, {
    value: valueItem,
    ...
    placeholder,
    renderValue
  })), import_react52.default.createElement(PickerCaret_default, {
    visible: true,
    busy,
    icon: selectIcon,
    spinner: busySpinner
  })), shouldRenderPopup && import_react52.default.createElement(Popup2, _extends25({}, popupProps, {
    dropUp,
    open: currentOpen,
    transition: popupTransition,
    onEntered: focus,
    onEntering: () => listRef.current.scrollIntoView()
  }), import_react52.default.createElement(ListComponent, _extends25({}, listProps, {
    id: listId,
    data,
    tabIndex: -1,
    disabled: disabled2,
  ...
  })), showCreateOption && import_react52.default.createElement(AddToListOption_default, {
...
var propTypes10 = {
  ...
  onMove: import_prop_types11.default.func,
  onHoverOption: import_prop_types11.default.func,
  optionComponent: import_prop_types11.default.elementType,
  renderItem: import_prop_types11.default.func,
  renderGroup: import_prop_types11.default.func,
  focusedItem: import_prop_types11.default.any,
  selectedItem: import_prop_types11.default.any,
  searchTerm: import_prop_types11.default.string,
  /**
   * @example false
   */
  disabled: disabled.acceptsArray,
  messages: import_prop_types11.default.shape({
    emptyList: import_prop_types11.default.func.isRequired
  })
};
var Listbox = import_react53.default.forwardRef(function Listbox2(_ref, _outerRef) {
  let {
    defaultValue,
    value: propsValue,
  ...
  const accessors = useAccessors(textField, dataKey);
  const dataItems = (0, import_react53.useMemo)(() => makeArray(value, multiple).map((item) => accessors.findOrSelf(data, item)), [value, multiple, accessors, data]);
  const ref = (0, import_react53.useRef)(null);
  const lastItemRef = (0, import_react53.useRef)(dataItems[dataItems.length - 1]);
  const list = useFocusList({
    scope: ref,
  ...
  return import_react53.default.createElement(FocusListContext.Provider, {
    value: list.context
  }, import_react53.default.createElement(List_default, _extends26({}, props, widgetProps, {
    disabled: disabled2,
...
var propTypes11 = {
  value: import_prop_types12.default.string,
  placeholder: import_prop_types12.default.string,
  maxLength: import_prop_types12.default.number,
  onChange: import_prop_types12.default.func.isRequired,
  disabled,
  readOnly: disabled
};
var MultiselectInput = import_react54.default.forwardRef((_ref, ref) => {
  let {
    disabled: disabled2,
    readOnly
  ...
  return import_react54.default.createElement("input", _extends27({
    spellCheck: "false",
    autoCapitalize: "off"
  }, props, {
    size,
...
function MultiselectTag({
  ...
  }, children), import_react55.default.createElement("button", {
    type: "button",
    tabIndex: -1,
...
function MultiselectTagList({
  ...
  return import_react56.default.createElement("div", {
    ...
    return import_react56.default.createElement(TagOption, {
      key: i,
      dataItem: item,
      onRemove: onDelete,
      clearTagIcon,
...
var propTypes12 = {
   ...
   * ): void}
   */
  onSearch: import_prop_types13.default.func,
  open: import_prop_types13.default.bool,
  handleOpen: import_prop_types13.default.func,
  //-------------------------------------------
  dataKey: accessor,
  textField: accessor,
  renderTagValue: import_prop_types13.default.func,
  renderListItem: import_prop_types13.default.func,
  renderListGroup: import_prop_types13.default.func,
  groupBy: accessor,
  allowCreate: import_prop_types13.default.oneOf([true, false, "onFilter"]),
  /**
   *
   * @type { (dataItem: ?any, metadata: { originalEvent: SyntheticEvent }) => void }
   */
   ...
   */
  onCreate: import_prop_types13.default.func,
  busy: import_prop_types13.default.bool,
  /** Specify the element used to render the select (down arrow) icon. */
  selectIcon: import_prop_types13.default.node,
  /** Specify the element used to render tag clear icons. */
  clearTagIcon: import_prop_types13.default.node,
  /** Specify the element used to render the busy indicator */
  busySpinner: import_prop_types13.default.node,
  dropUp: import_prop_types13.default.bool,
  popupTransition: import_prop_types13.default.elementType,
  /** Adds a css class to the input container element. */
  containerClassName: import_prop_types13.default.string,
  inputProps: import_prop_types13.default.object,
  listProps: import_prop_types13.default.object,
  ...
  showPlaceholderWithValues: import_prop_types13.default.bool,
  /** Continue to show the selected items in the dropdown list */
  showSelectedItemsInList: import_prop_types13.default.bool,
  disabled: disabled.acceptsArray,
  readOnly: disabled,
...
function useMultiselectData(value = EMPTY_ARRAY, data, accessors, filter, searchTerm, showSelectedItemsInList) {
  data = (0, import_react57.useMemo)(() => showSelectedItemsInList ? data : data.filter((i) => !value.some((v) => accessors.matches(i, v))), [data, showSelectedItemsInList, value, accessors]);
  return [useFilteredData(data, filter || false, searchTerm, accessors.text), data.length];
}
var Multiselect = import_react57.default.forwardRef(function Multiselect2(_ref, outerRef) {
  let {
    dataKey,
    textField,
    autoFocus,
  ...
  const dataItems = (0, import_react57.useMemo)(() => currentValue.map((item) => accessors.findOrSelf(rawData, item)), [rawData, currentValue, accessors]);
  ...
  const deletingRef = (0, import_react57.useRef)(false);
  ...
  (0, import_react57.useImperativeHandle)(outerRef, () => ({
    focus
  }));
  let shouldRenderPopup = useFirstFocusedRender(focused, currentOpen);
  let shouldRenderTags = !!dataItems.length;
  let inputOwns = `${listId} ` + (shouldRenderTags ? tagsId : "") + (showCreateOption ? createId : "");
  return import_react57.default.createElement(Widget_default, _extends28({}, elementProps, {
    ref,
    open: currentOpen,
    dropUp,
    focused,
  ...
  }), import_react57.default.createElement(WidgetPicker_default, {
    onClick: handleClick,
    onTouchEnd: handleClick,
    onDoubleClick: handleDoubleClick,
    className: (0, import_classnames24.default)(containerClassName, "rw-widget-input")
  }, import_react57.default.createElement(FocusListContext.Provider, {
    value: tagList.context
  }, import_react57.default.createElement(TagList, {
    id: tagsId,
    textAccessor: accessors.text,
    clearTagIcon,
    ...
    tagOptionComponent,
    renderTagValue
  }, import_react57.default.createElement(MultiselectInput_default, _extends28({}, inputProps, {
    role: "combobox",
    autoFocus,
    tabIndex: tabIndex || 0,
    "aria-expanded": !!currentOpen,
    ...
    onChange: handleInputChange,
    ref: inputRef
  })))), import_react57.default.createElement(PickerCaret_default, {
    busy,
    spinner: busySpinner,
    icon: selectIcon,
    visible: focused
    ...
    value: list.context
  }, shouldRenderPopup && import_react57.default.createElement(Popup2, _extends28({}, popupProps, {
    dropUp,
    open: currentOpen,
    transition: popupTransition,
    onEntering: () => listRef.current.scrollIntoView()
  }), import_react57.default.createElement(ListComponent, _extends28({}, listProps, {
    id: listId,
    data,
    tabIndex: -1,
    disabled: disabled2,
  ...
  })), showCreateOption && import_react57.default.createElement(AddToListOption_default, {
    onSelect: handleCreate
...
var NumberPickerInput = class extends import_react58.default.Component {
  constructor(...args) {
    super(...args);
    this.state = {};
  ...
  isSelectingAllText() {
    const node3 = canUseDOM_default && (0, import_react_dom.findDOMNode)(this);
  ...
  render() {
    ...
    return import_react58.default.createElement(Input_default, _extends29({}, props, {
      ref: innerRef,
      inputMode: "numeric",
      className: "rw-widget-input",
...
NumberPickerInput.propTypes = {
  ...
  editing: import_prop_types14.default.bool,
  placeholder: import_prop_types14.default.string,
  localizer: import_prop_types14.default.object.isRequired,
  parse: import_prop_types14.default.func,
...
var propTypes13 = {
   ...
   */
  precision: import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.oneOf(["auto"])]),
  /**
   ...
   */
  format: import_prop_types15.default.any,
  parse: import_prop_types15.default.func,
  incrementIcon: import_prop_types15.default.node,
  decrementIcon: import_prop_types15.default.node,
  /** @ignore */
  tabIndex: import_prop_types15.default.any,
  ...
  onKeyPress: import_prop_types15.default.func,
  ...
  messages: import_prop_types15.default.shape({
    increment: import_prop_types15.default.string,
    decrement: import_prop_types15.default.string
  }),
  /** @ignore */
  localizer: import_prop_types15.default.object
};
var defaultProps3 = {
...
function NumberPicker(uncontrolledProps) {
  ...
  const repeaterRef = (0, import_react59.useRef)(null);
  const [focusEvents, focused] = useFocusManager2(ref, uncontrolledProps, {
    willHandle(focused2) {
      if (focused2)
        focus();
  ...
  return import_react59.default.createElement(Widget_default, _extends30({}, elementProps, {
    focused,
    disabled: disabled2,
    readOnly,
    onKeyDown: handleKeyDown
    ...
    className: containerClassName
  }, import_react59.default.createElement(NumberInput_default, _extends30({}, inputProps, {
    role: "spinbutton",
    tabIndex,
    value: clampedValue,
    placeholder,
  ...
  }, import_react59.default.createElement(Button_default, {
    icon: incrementIcon,
